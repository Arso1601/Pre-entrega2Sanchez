        ...
        <div class="container">
            ...
            {carrito.length > 0 ?
                ...
                <>
                    ...
                    <Link to="/checkout"><button type="button" class="button-compra btn btn-warning">Comprar</button></Link>
                    <button type="button"  class="button-compra btn btn-danger" onClick={handleVaciar}>vaciar</button>
                </> :
